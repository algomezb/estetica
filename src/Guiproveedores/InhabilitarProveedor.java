 ...
 * @author Lizet
 */
public class InhabilitarProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Inhabilitar proveedores");
    ...
    String Estado= "Inhabilitado";
      manejoprov.inhabilitar(ids,Estado); 
    Consultar();
...
public void Consultar(){ 
      int id=Integer.parseInt(jTextField11.getText());
        ...
        rs=(ResultSet) manejoprov.consultar(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InhabilitarProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InhabilitarProveedor().setVisible(true);
            }
        });
    }
